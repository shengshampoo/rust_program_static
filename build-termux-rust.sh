...
cd dufs
RUSTFLAGS="-C target-feature=+crt-static -C linker=/android-ndk-r29/toolchains/llvm/prebuilt/linux-86_64/bin/aarch64-linux-android23-clang -C strip=symbols -C opt-level=s" cargo build --target aarch64-linux-android --release
